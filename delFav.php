...
<script>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        $stmt = $db->stmt_init();
        if($stmt->prepare("SELECT job_id FROM proj_favorite where job_id=? and cid=?") or die(mysqli_error($db))) {
			...
			if($result->num_rows === 0) {
                ...
                if ($db->query("DELETE FROM proj_favorite WHERE cid='$user' AND job_id=$jid")){
                        ?>
                        <script type = "text/javascript">
