...
<?php
        ...
        if ($db->query($sql)){
            echo "<center><h3>The job has been removed from your favorites list!</h3><a class='btn btn-secondary btn-sm' href='GetJob.php?jid=$job_id' role='button'>Return to Job Page</a></center>";
        } else {
            echo "error";
