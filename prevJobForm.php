...
<?php
        ...
        echo "<form action='prevJobConfirmation.php' method='post'>
        <div class='input-group'>
          Start Date:<input class='form-control' type='date' required name='pstart'/>
          <br/><br/>
        </div>
        <div class='input-group'>
          End Date:<input class='form-control' type='date' required name='pend'/>
          <br/><br/>
        </div>
